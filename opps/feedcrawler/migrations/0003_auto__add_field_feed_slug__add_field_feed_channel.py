...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'feedcrawler_feed', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=150),
                      keep_default=False)

        # Adding field 'Feed.channel'
        db.add_column(u'feedcrawler_feed', 'channel',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['channels.Channel'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feed.slug'
        db.delete_column(u'feedcrawler_feed', 'slug')

        # Deleting field 'Feed.channel'
        db.delete_column(u'feedcrawler_feed', 'channel_id')
