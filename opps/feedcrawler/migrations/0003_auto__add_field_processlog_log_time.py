...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProcessLog.log_time'
        db.add_column(u'feedcrawler_processlog', 'log_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProcessLog.log_time'
        db.delete_column(u'feedcrawler_processlog', 'log_time')
