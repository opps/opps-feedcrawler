...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feed.main_image'
        db.add_column(u'feedcrawler_feed', 'main_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='feed_image', null=True, on_delete=models.SET_NULL, to=orm['images.Image']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feed.main_image'
        db.delete_column(u'feedcrawler_feed', 'main_image_id')
