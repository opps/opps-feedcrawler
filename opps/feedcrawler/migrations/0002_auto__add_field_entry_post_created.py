...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.post_created'
        db.add_column(u'feedcrawler_entry', 'post_created',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.post_created'
        db.delete_column(u'feedcrawler_entry', 'post_created')
