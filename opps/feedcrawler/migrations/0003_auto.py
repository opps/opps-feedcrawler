...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field mirror_site on 'Feed'
        m2m_table_name = db.shorten_name(u'feedcrawler_feed_mirror_site')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('feed', models.ForeignKey(orm[u'feedcrawler.feed'], null=False)),
    ...
    def backwards(self, orm):
        # Removing M2M table for field mirror_site on 'Feed'
        db.delete_table(db.shorten_name(u'feedcrawler_feed_mirror_site'))
