...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.entry_category'
        db.add_column(u'feedcrawler_entry', 'entry_category',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Entry.entry_category_code'
        db.add_column(u'feedcrawler_entry', 'entry_category_code',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Entry.entry_category'
        db.delete_column(u'feedcrawler_entry', 'entry_category')

        # Deleting field 'Entry.entry_category_code'
        db.delete_column(u'feedcrawler_entry', 'entry_category_code')
