...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feed.publish_entries'
        db.add_column(u'feedcrawler_feed', 'publish_entries',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feed.publish_entries'
        db.delete_column(u'feedcrawler_feed', 'publish_entries')
